...
function initialize() {
  ...
  const questionMark = QUESTION_MARKS.Q9;
  const isRequired = false; // 是否必填

  // 绑定 next__btn 点击事件
  bindNextButtonClickBySelect(nextButton, CHOICE_TYPE.SINGLE, checkboxes, questionMark, isRequired);
