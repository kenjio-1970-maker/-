import { QUESTION_MARKS, getCheckedValuesByName, CHOICE_TYPE, bindNextButtonClickBySelect, populateCheckboxesFromStorage } from "./common.js"; // 引入 bindNextButtonClick
...
function initialize() {
  ...
  const questionMark = QUESTION_MARKS.Q3;
