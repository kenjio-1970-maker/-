...
function initialize() {
  ...
  const questionMark = QUESTION_MARKS.Q10;
  const isRequired = true; // 是否必填

  // 绑定 next__btn 点击事件
  bindNextButtonClickBySelect(nextButton, CHOICE_TYPE.MULTI, checkboxes, questionMark, isRequired);
