import { QUESTION_MARKS, CHOICE_TYPE, bindNextButtonClickBySelect, populateCheckboxesFromStorage } from "./common.js"; // 引入 populateCheckboxesFromStorage
...
function initialize() {
    ...
    const questionMark = QUESTION_MARKS.Q1;
